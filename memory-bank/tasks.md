...
- [ ] Модальное окно открывается/закрывается корректно
- [ ] Правила отображаются читабельно и структурированно
- [ ] Модальное окно закрывается по Escape и клику на backdrop
